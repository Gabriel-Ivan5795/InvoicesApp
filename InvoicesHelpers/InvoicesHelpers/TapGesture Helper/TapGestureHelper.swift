...
//  NowAppHelpers
//
//  Created by Cosmin on 22.12.2021.
//
...
extension UITapGestureRecognizer {
   ...
   public func didTapAttributedTextInLabel(label: UILabel, inRange targetRange: NSRange) -> Bool {
       ...
       // If the label has text alignment. Delete this code if the label has a default alignment (left). It is possible to add the attribute in the previous addition.
